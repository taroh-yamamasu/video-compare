...
enum AppTheme {
    ...
    static let background = Color(red: 0.025, green: 0.026, blue: 0.032)
    static let surface = Color(red: 0.105, green: 0.105, blue: 0.13)
    static let elevatedSurface = Color(red: 0.155, green: 0.15, blue: 0.18)
    static let subtleSurface = Color.white.opacity(0.075)
